...
internal class LoadBiliBiliPackageManifestOperation : AsyncOperationBase
{
    [UnityEngine.Scripting.Preserve]
    private enum ESteps
    {
    ...
    [UnityEngine.Scripting.Preserve]
    internal LoadBiliBiliPackageManifestOperation(BiliBiliFileSystem fileSystem, string packageVersion, string packageHash, int timeout)
    {
    ...
    {
        _requestCount = WebRequestCounter.GetRequestFailedCount(_fileSystem.PackageName, nameof(LoadBiliBiliPackageManifestOperation));
    ...
    public override void InternalOnUpdate()
    {
        ...
        if (_steps == ESteps.RequestFileData)
        {
            ...
            else
            {
                ...
                WebRequestCounter.RecordRequestFailed(_fileSystem.PackageName, nameof(LoadBiliBiliPackageManifestOperation));
            }
        }
        ...
        if (_steps == ESteps.VerifyFileData)
        {
            ...
            else
            {
                _steps = ESteps.Done;
                Status = EOperationStatus.Failed;
                Error = "Failed to verify BiliBili package manifest file!";
            }
        }
