...
internal class BLBFSRequestPackageVersionOperation : FSRequestPackageVersionOperation
{
    [UnityEngine.Scripting.Preserve]
    private enum ESteps
    {
    ...
    private RequestBiliBiliPackageVersionOperation _requestWebPackageVersionOp;
    private ESteps _steps = ESteps.None;


    [UnityEngine.Scripting.Preserve]
    internal BLBFSRequestPackageVersionOperation(BiliBiliFileSystem fileSystem, bool appendTimeTicks, int timeout)
    {
    ...
    public override void InternalOnUpdate()
    {
        ...
        if (_steps == ESteps.RequestPackageVersion)
        {
            ...
            {
                _requestWebPackageVersionOp = new RequestBiliBiliPackageVersionOperation(_fileSystem, _appendTimeTicks, _timeout);
