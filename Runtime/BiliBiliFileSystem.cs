...
public static class BiliBiliFileSystemCreater
{
    [UnityEngine.Scripting.Preserve]
    public static FileSystemParameters CreateBiliBiliFileSystemParameters(IRemoteServices remoteServices = null)
    {
        string fileSystemClass = typeof(BiliBiliFileSystem).FullName;
    ...
    [UnityEngine.Scripting.Preserve]
    public static FileSystemParameters CreateBiliBiliPathFileSystemParameters(string buildinPackRoot)
    {
        string fileSystemClass = typeof(BiliBiliFileSystem).FullName;
        var fileSystemParams = new FileSystemParameters(fileSystemClass, null);
        IRemoteServices remoteServices = new BiliBiliFileSystem.WebRemoteServices(buildinPackRoot);
        fileSystemParams.AddParameter(FileSystemParametersDefine.REMOTE_SERVICES, remoteServices);
        return fileSystemParams;
    }
}
...
/// <summary>
/// 哔哩哔哩小游戏文件系统
/// 参考：https://open.bilibili.com/
/// </summary>
[UnityEngine.Scripting.Preserve]
internal class BiliBiliFileSystem : IFileSystem
{
    [UnityEngine.Scripting.Preserve]
    ...
    {
        var operation = new BLBFSInitializeOperation(this);
    ...
    public virtual FSLoadPackageManifestOperation LoadPackageManifestAsync(string packageVersion, int timeout)
    {
        ...
        var operation = new BLBFSLoadPackageManifestOperation(this, packageVersion, timeout);
        OperationSystem.StartOperation(PackageName, operation);
        return operation;
    }
    ...
    {
        var operation = new BLBFSRequestPackageVersionOperation(this, appendTimeTicks, timeout);
        OperationSystem.StartOperation(PackageName, operation);
        return operation;
    }
    ...
    public virtual FSDownloadFileOperation DownloadFileAsync(PackageBundle bundle, DownloadParam param)
    {
        ...
        var operation = new BLBFSDownloadFileOperation(this, bundle, param);
        OperationSystem.StartOperation(PackageName, operation);
        return operation;
    }
    ...
    {
        var operation = new BLBFSLoadBundleOperation(this, bundle, PackageVersion);
        OperationSystem.StartOperation(PackageName, operation);
        return operation;
    }
